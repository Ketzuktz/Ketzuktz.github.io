...
from gicg_sim.types.event import EventBase, EventDrawCard, EventEnum
from gicg_sim.types.operation import (PlayerOpDrawCard, PlayerOperationBase,
                                      PlayerOperationEnum)
    ...
    def map_operation_events(operation: PlayerOperationBase) -> list[EventBase]:
        ...
        match operation.op_type:
            case PlayerOperationEnum.DrawCard:
                ...
                ), f"operation with type {operation.op_type} must be PlayerOpDrawCard."
                events.append(
