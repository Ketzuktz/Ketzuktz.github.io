...
class PhaseStatusEnum(Enum):
    ...
    RA_all_continue_1 = "[P1][R1] All continue 1"
    RA_all_continue_2 = "[P1][R2] All continue 2"
    # only continue, but next is player i
    RA_only_continue_1 = "[P1][R3] Only continue 1"
    RA_only_continue_2 = "[P1][R4] Only continue 2"
    # all end
    RA_all_end = "[P1][R5] All end"
